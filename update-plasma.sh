...
sleep 3
sudo pacman -S --noconfirm --needed gwenview spectacle ark okular kcalc skanlite partitionmanager elisa krdc ktorrent kamoso kmail kamail-account-wizard kdegraphics-mobipocket kdegraphics-thumbnailers breeze-plymouth isoimagewriter
