...
sudo mkdir -p /usr/share/backgrounds/custom/ && sudo cp dreaming.png goku.png saiyan.png /usr/share/backgrounds/custom/ && sudo cp custom.xml /usr/share/gnome-background-properties/
echo -e "${LPURPLE} COMPILANDO DASH-TO-DOCK... ${OFF}"
sleep 3
