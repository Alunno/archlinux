...
sudo pacman -Syu && sudo pacman -S git -y && sudo pacman -Rsnc gnome-contacts gnome-maps gnome-weather gnome-characters gnome-clocks gnome-software gnome-music epiphany
