...
sleep 6
echo -e "${GREEN} Atualizando o Sistema ${OFF}"
sudo pacman -Syu && sudo pacman -Rsnc gnome-contacts gnome-maps gnome-weather gnome-characters gnome-clocks gnome-software gnome-music epiphany
